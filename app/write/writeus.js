...
export default function WriteUC() {
    ...
    return (
        <div>
            <div className="p-20">
                ...
                <Form action={'/api/' + selectedOption + '/write'} method="POST">
                    <Form.Label>종목선택</Form.Label>
                    ...
                    <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                        ...
                        <Form.Control as="textarea" rows={15} name="content" />
                    </Form.Group>
                    ...
                    <Form.Control type="hidden" name="postAt" value={
                        commentAt
                    }/>
