...
export default async function Edit(props){
    ...
    let result = await db.collection('post_baseball').findOne({_id:new ObjectId(props.params.id)})
    ...
    return(
        ...
        //     </form>
        // </div>
        <UpdatePost _id={result._id.toString()} title={result.title} content={result.content} filesrc={JSON.parse(result.filesrc)}></UpdatePost>
